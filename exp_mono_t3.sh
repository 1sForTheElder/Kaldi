...
do
  ...
  case $feat_type in
    delta) feats="ark,s,cs:apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/JOB/utt2spk scp:$sdata/JOB/cmvn.scp scp:$sdata/JOB/feats.scp ark:- | add-deltas $delta_opts1 ark:- ark:- |";;
  ...
  echo "the delta"${i}>>Q1_task3.txt;
  echo $((END-START))>>Q1_task3.txt
  command>>Q1_task3.txt more $dir/decode_test/scoring_kaldi/best_wer
  echo    >>Q1_task3.txt
